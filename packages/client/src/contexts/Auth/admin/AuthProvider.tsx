...
import { AuthContext, UserDetailsSchema, type UserDetailsType } from "@/contexts/Auth/admin/AuthContext";
...
export default function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const login = async (onSuccess: () => void = () => { }, onError: () => void = () => { }) => {
    try {
      ...
      if (e instanceof ZodError) toast.open(z.prettifyError(e), 'alert-error', true, 2000);
